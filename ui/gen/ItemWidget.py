...
class Ui_ItemWidget(object):
    def setupUi(self, ItemWidget):
        ...
        self.label_price.setMinimumSize(QtCore.QSize(0, 0))
        self.label_price.setMaximumSize(QtCore.QSize(150, 200))
        font = QtGui.QFont()
        font.setFamily("Palatino Linotype")
        ...
        self.verticalLayout_4.addWidget(self.label_price, 0, QtCore.Qt.AlignmentFlag.AlignTop)
