...
class Database:
    ...
    def add_product(self, article, name, category_id, descrip, manufacture_id, supplier_id,
        ...
        with self.cursor() as cur:
            cur.execute(
                ...
                (article, name, category_id, descrip, manufacture_id, supplier_id,
                 price, unit_id, quantity, discount, image_path)
            )
        self.conn.commit()
    ...
    def update_product(self, product_id, article, name, category_id, descrip, manufacture_id,
        ...
        with self.cursor() as cur:
            cur.execute(
                ...
                (article, name, category_id, descrip, manufacture_id, supplier_id,
                 price, unit_id, quantity, discount, image_path, product_id)
            )
        self.conn.commit()
